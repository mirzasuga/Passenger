...
import com.stickearn.stickpass.utils.AspectRatioImageView
 ...
 */
class AspectRatioImageView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : ImageView(context, attrs) {
